...
public class ConcurrentMap {
    public static void main() {
        ...
        Map< String, Integer > occurrences = new ConcurrentHashMap<>(); // Concurrent Hashmap
    ...
    private static void computeOccurrences( String filename, Map< String, Integer > occurrences ) {
        try {
            Files.lines( Paths.get(filename) )
                ...
                .forEach( s -> {
                    // Merge from ConcurrentHashMap is thread safe.
                    // Everything on the key, is thread safe and atomic.
                    // It is possible for different threads to access different key at the same time.
                    // Makes it faster than synchronizing on the entire hashmap.
